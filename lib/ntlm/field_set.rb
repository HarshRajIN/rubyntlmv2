    ...
    class FieldSet
      class << FieldSet
        ...
        def string(name, opts)
          add_field(name, NTLM::String, opts)
        end
        ...
        def int16LE(name, opts)
          add_field(name, NTLM::Int16LE, opts)
        end
        ...
        def int32LE(name, opts)
          add_field(name, NTLM::Int32LE, opts)
        end
        ...
        def int64LE(name, opts)
          add_field(name, NTLM::Int64LE, opts)
        end
        ...
        def security_buffer(name, opts)
          add_field(name, NTLM::SecurityBuffer, opts)
        end
